<%@ page import="com.bsu.registration.servlet.controller.FrontController" %>
...
<p>
    <c:set var="firstName" value="<%=request.getParameter(FrontController.FIRST_NAME)%>"/>
    <c:set var="lastName" value="<%=request.getParameter(FrontController.LAST_NAME)%>"/>
    <c:set var="companyName" value="<%=request.getParameter(FrontController.COMPANY_NAME)%>"/>
